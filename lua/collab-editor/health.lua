-- Health check for collab-editor
-- Run with :checkhealth collab-editor

local M = {}

M.check = function()
  vim.health.start("collab-editor")
  ...
  if source:sub(1, 1) == "@" then
    plugin_path = source:sub(2):gsub("/lua/collab%-editor/health%.lua$", "")
  end
